...
<body style="width:1024px; margin:auto; background-color: #5c5c5c;">
    ...
    <div style="background-color: white">
        ...
        <!-- ******************************************************  TEAM  ************************************************************* -->
        <h1 id="team" style="text-align: center; background-color: black; font-family: Arial, Helvetica, sans-serif; color:#82ebaa;">Team</h1>
            ...
            <div class="shtylle">
                <div class="karta">
                    ...
                    <a target="_blank" href="alb.html ">
                        <img src="Images/Veranda.jpeg" alt="Veranda" style="width:100%"> </a>
                    <div class="vazo">
                        <h2>Veranda Blakaj</h2>

                        <p style="color: grey"> CEO &amp; Designer</p>

                        <p> <a href="mailto:verandablakaj@gmail.com" style=" text-decoration: none; color: white;">
        ...
        <form method="get" action="" id="mainForm">
            ...
            <fieldset>
                ...
                <p id="setFunk" style=" text-transform: uppercase; text-align: center; color:#82ebaa; cursor:pointer;"><u>We really appreciate your feedback</u></p>
