...
.modal2-content {
  ...
  width: 700px;
    ...
    <script>
        ...
        function search(){
    var text = "Green Code programme is an ideal way for schools to embark on a meaningful path towards improving the environment in both the school and the local community while at the same time having a life-long positive impact on the lives of young people and their families."; 
    ...
    <div style="background-color: white">
       ...
       ?>
        ...
        <div class="pano">
            ...
            <div><img src="Images/ecoconcept.jpg" alt="Green Code" style="width:600px; height:300px; float:left; width:60%; ">
            </div>
            <div style="background-color:#82ebaa; width:600px; height:300px; float:right; width:40%;">
                ...
                <p style="padding: 10px; color:white;">We are passionate about making our new classrooms not only functional but also places which inspire students and teachers alike. Due to this, we are keen not to design another conventional building that looks institutional, we take our inspiration from natures curves.
                    ...
                    <a target="_blank" href="login.php" class="button">Continue Reading &raquo;</a></p>
        ...
        <div>
                ...
                <div style="float: right; padding-right: 20px; padding-top: 30px; ">
                    ...
                    <ul style="list-style: none;">
                        ...
                        <li>
                            ...
                            <a target="_blank" href="login.php" style=" color: #82ebaa; float: right; text-decoration: none">Continue Reading</a>
                        </li>
                        <hr>
            ...
            <article class="article">
                ...
                <div class="container">
                    ...
                    <div class="content"><a href="login.php">Green Flag</a></div>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="content"><a href="login.php">-EcoWarriors</a></div>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="content"><a href="login.php">Clean Air</a></div>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="content"><a href="login.php">WWF Conference</a></div>
                </div>
            ...
            <section class="section">
                ...
                <p id="search">Green Code programme is an ideal way for schools to embark on a meaningful path towards improving the environment in both the school and the local community while at the same time having a life-long positive impact on the lives of young people and their families.</p>

                <p>Green Code programme provides a unique opportunity that empowers pupils to lead change within their school and have a positive impact in their wider community.</p>

                <p> The programme encourages pupils of all ages and abilities to work together to develop their knowledge and environmental awareness. Independent research into Green Code programme in England found evidence of the positive impacts on pupils, including increased confidence, development of leaderships skills, improved pupil well-being and behaviour and greater motivation at school.</p>

                <p>While the Seven Steps are the most important aspect of Green Code programme, schools also work on topics to help give the programme even more structure;<b> marine, biodiversity, energy, litter, global citizenship, healthy living, school grounds, transport, waste and water</b>.</p>
