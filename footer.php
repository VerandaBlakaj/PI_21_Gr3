...
<footer class="footer">
    ...
    <div class="details">
        ...
        <p style="color: antiquewhite; font-size: 14px"><u><i><a href="#">www.greencode.com</a></i></u></p>
...
<div class="template" style="float:left">
    ...
    Copyrights &copy; 2021 Green Code -All rights reserved.
</div>
